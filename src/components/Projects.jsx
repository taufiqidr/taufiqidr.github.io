    ...
    <section id="projects" className="bg-dark container h-auto mb-3">
      <div className="p-3 pb-md-4 mx-auto text-center">
        ...
        <p className="fs-5 text-light">
          I have some projects that I have worked on and projects that are still
          in development. Here are some of them:
        </p>
      </div>
            ...
            <div className="col">
              <div className="card shadow-sm">
                ...
                <div className="card-body">
                  ...
                  <p className="card-text">
                    This is the project that I developed for my thesis. The
                    model is written in Python with Tensorflow and Keras as the
                    framework. This model achieved an average accuracy value of
                    88.60%, an average sensitivity of 77.20% and an average
                    specificity of 92.40%.
                  </p>
                  <div className="d-flex justify-content-between align-items-center">
                    <strong className="">Status: Live 🔴</strong>
                  </div>
